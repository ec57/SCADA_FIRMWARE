...
Adafruit_INA219 ina219_0(0x40); //U1:GND,GND
Adafruit_INA219 ina219_1(0x44); //U2:VCC,GND
Adafruit_INA219 ina219_2(0x48); //U3:SDA,GND
Adafruit_INA219 ina219_3(0x4C); //U4:SCL,GND
...
void setup() {
    ...
    //configTime(-3600*8, daylightOffset_sec, ntpServer);
    ////printLocalTime();
...
void loop() {
    ...
    // print power monitor reading
    /*Serial.println(ina219_0.toString()
        + ina219_1.toString()
        + ina219_2.toString()
        + ina219_3.toString());
        */
        // print voltage array readings
