...
public:
	...
	void setCalibration_32V_10A();  // configured for SCADA board
...
public:
	...
	uint32_t ina219_currentDivider_mA; // not used
	float ina219_powerMultiplier_mW;
	float ina219_currentLSB;
	float ina219_shuntVoltageLSB;
